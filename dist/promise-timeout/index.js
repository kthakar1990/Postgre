...
function extend() {
    ...
    if (prototype.timeout)
        return;
    prototype.timeout = function (milliSeconds, contextOnTimeout) {
        let timeoutId;
        ...
        const timeoutFunction = new Promise((_resolve, reject) => {
            timeoutId = setTimeout(() => {
                ...
                reject(Object.assign(deepCopy(contextOnTimeout), { human_readable_duration: durationString, duration: milliSeconds * seconds_1.Seconds.oneMillisecond }));
            }, milliSeconds);
        });
